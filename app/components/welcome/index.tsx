...
const Welcome: FC<IWelcomeProps> = ({
  ...
  const renderHeader = () => {
    return (
      <div className='absolute top-0 left-0 right-0 flex items-center justify-between border-b border-gray-100 mobile:h-12 tablet:h-16 px-8 bg-white' style={{ backgroundColor: '#292a2d', fontWeight: 'bold' }}>
        <div className='text-gray-900' style={{ color: '#fff' }}>{conversationName}</div>
      </div>
    )
  }
